...
defined('ADMINURL')        		OR 	define('ADMINURL', 'TDundZLiveaKUJDOCSFOSZDem');

defined('FURL')        			OR 	define('FURL', 'atamaicliste');

defined('SITE')        			OR 	define('SITE', 'tfunds_site_settings');

defined('AD')        			OR 	define('AD', 'nzanmidnwe');

defined('ADACT')        		OR 	define('ADACT', 'nzanmidnwe_activity');
...
defined('USERS') 				OR 	define('USERS', 'trfdznreaseuer');
