              ...
              <div class="form-body">
                  ...
                  <div class="row justify-content-md-center">
                    ...
                    <fieldset class="form-group">
                     ...
                     <?php foreach($lang as $key => $value){ ?>
                      <option value="<?php echo $value->id;?>"  <?php if($email->language == $value->id ) {echo 'selected';} ?> ><?php echo $value->lang_name;     ?></option> 
                      <?php } ?> 
                      </select>
                    </fieldset>
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <input type="text" id="name" class="form-control border-primary" placeholder="Name" name="name" value="<?php echo $email->name ; ?>">
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <input type="text" id="subject" class="form-control border-primary" placeholder="Subject" name="subject" value="<?php echo $email->subject ; ?>">
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <textarea class="form-control" id="content_description" name="content_description" rows="20"><?php echo $email->template; ?></textarea>
