              ...
              <div class="row justify-content-md-center">
                ...
                <div class="row justify-content-md-center">
                  ...
                  <div class="col-lg-6 col-md-12">
                   ...
                   <div class="row justify-content-md-center">
                  <div class="col-lg-6 col-md-12">
                       <img width="200" height="100" src="<?php echo base_url().'assets/img/site/'.$presen->image;?>"/>
                ...
                <?php } ?>
                  ...
                  <?php if($presen->document){?>
                   ...
                   <div class="row justify-content-md-center">
                  <div class="col-lg-6 col-md-12">
                      <a href="<?php echo base_url().'assets/img/site/'.$presen->document;?>"/ target="_blank">View Document </a>
