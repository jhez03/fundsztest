               ...
               <!--    <div class="row justify-content-md-center">
                    ...
                    <fieldset class="form-group">
                     ...
                     <?php foreach($lang as $key => $value){ ?>
                      <option value="<?php echo $value->id;?>"  <?php if($address->language == $value->id ) {echo 'selected';} ?> ><?php echo $value->lang_name;     ?></option> 
                      <?php } ?> 
                      </select>
                    </fieldset>
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <input type="text" id="heading" class="form-control border-primary" placeholder="Heading" name="heading" value="<?php echo $address->heading ; ?>">
                  </div>
                ...
                <div class="row justify-content-md-center">
                  ...
                  <label for="userinput1">Address</label>
                    ...
                    <textarea class="form-control" id="address_name" name="address_name" rows="3"><?php echo encrypt_decrypt('decrypt', $address->address_name); ?></textarea>
                  </div>
