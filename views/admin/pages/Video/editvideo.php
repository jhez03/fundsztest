              ...
              <div class="row justify-content-md-center">
                ...
                <div class="row justify-content-md-center">
                  ...
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <input type="text" id="code" class="form-control border-primary" placeholder="code" name="code" value="<?php echo $video->code ; ?>">
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <fieldset class="form-group col-md-6 mb-2">
                      ...
                      <textarea class="form-control" name= "link" id="link" rows="3"
                        placeholder="link"><?php echo $video->link ; ?></textarea>
                    </fieldset>
                  </div>
                  </div>
                  <div class="row justify-content-md-center">
            ...
            <form class="form" id="add_video" method="post" enctype="multipart/form-data">
              ...
              <div class="form-body">
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    <label for="userinput1">Code</label>
                    <input type="text" id="addcode" class="form-control border-primary" placeholder="Code" name="addcode" value="">
                  </div>
