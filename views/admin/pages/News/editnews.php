...
<section id="form-action-layouts">
  <div class="row">
    <div class="col-sm-6">
      <div class="content-header">Edit Document</div>
    </div>
    <div class="col-sm-6">
      <?php 
        ...
        <div class="card-body">
          <div class="px-3">
            ...
            <form class="form" id="edit_doc" method="post" enctype="multipart/form-data">
              ...
              <div class="form-body">
                  ...
                  <div class="row justify-content-md-center">
                    ...
                    <fieldset class="form-group">
                     ...
                     <?php foreach($lang as $key => $value){ ?>
                      <option value="<?php echo $value->id;?>"  <?php if($doc->language == $value->id ) {echo 'selected';} ?> ><?php echo $value->lang_name;     ?></option> 
                      <?php } ?> 
                      </select>
                    </fieldset>
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    ...
                    <input type="text" id="title" class="form-control border-primary" placeholder="Title" name="title" value="<?php echo $doc->title ; ?>">
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="col-lg-6 col-md-12">
                    <fieldset class="form-group">
                      <label for="doc"> Document (Only pdf file)</label>
              ...
              <div class="row justify-content-md-center">
                  <div class="col-lg-6 col-md-12">
                      <a href="<?php echo base_url().'assets/img/site/document/'.$doc->document;?>"/ target="_blank">View Document </a>
