...
<div class="col-12 col-lg-10 content_col pl-3 pl-lg-3 pr-3 pr-lg-0">
      ...
      <div class="pl-3 pl-lg-3 pr-3 pr-lg-0 mt-3">
        <h3 class="text-white font_weight_400 font_asap"><?php echo 'Indirect Partners'; ?></h3>
               ...
               <div class="partners-sec">
                   <h4><?php echo lang('Data About Partner'); ?></h4>
                    ...
                    <form class="mt-3" id="about_partner">
                      ...
                      <div class="form-group col-12 col-md-9">
                        <input class="form-control form-control-style" placeholder="<?php echo lang('ID or ETH Wallet Partner'); ?>" name="partner_id" id="partner_id">
                      </div>
          ...
          <div class="row mt-3">
            <div class="col-12">
               <div class="sell_level_bg_2 partners-sec px-4 py-4 text-white">
                    ...
                    ?>
                   <div class="partners-sec  <?php echo $viewTree=='yes' ? 'scroll-content' : ''?>"> <!-- partners-sec-tree -->
